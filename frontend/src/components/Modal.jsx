              ...
              <div className="mb-4 grid grid-cols-2 gap-4">
                ...
                <div className="col-span-2">
                  ...
                  <input
                    ...
                    name="profileImage"
                    id="profileImage"
                    className="bg-gray-50 focus:ring-primary-600 focus:border-primary-600 dark:focus:ring-primary-500 dark:focus:border-primary-500 block w-full rounded-lg border border-gray-300 p-2.5 text-sm text-gray-900 dark:border-gray-500 dark:bg-gray-600 dark:text-white dark:placeholder-gray-400"
